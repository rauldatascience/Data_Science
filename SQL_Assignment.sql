...
-- Q-1. Write an SQL query to fetch “FIRST_NAME” from Worker table using the alias name as <WORKER_NAME>. SOLVE

SELECT 
    FIRST_NAME AS first_name_worker
FROM
    Worker;

-- Q-2. Write an SQL query to fetch “FIRST_NAME” from Worker table in upper case. SOLVE

SELECT 
    UPPER(FIRST_NAME) AS first_name_worker
FROM
    Worker;

-- Q-3. Write an SQL query to fetch unique values of DEPARTMENT from Worker table. SOLVE
...
-- Q-4. Write an SQL query to print the first three characters of  FIRST_NAME from Worker table. SOLVE
